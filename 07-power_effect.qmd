...
We consider a two-sample $t$-test for the study of @Liu.Rim.Min.Min:2022 discussed in @exm-LiuRimMinMin2022E1. The difference in average response index is `r round(as.numeric(diff(ttest$estimate)), 3)`, indicating that the responder have a higher score. The $p$-value is `r round(ttest$p.value,3)`, showing a small effect. 
