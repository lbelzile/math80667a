...
#|   type. Source: Mine Çetinkaya-Rundel and OpenIntro, distributed under the [CC BY-SA
...
@fig-openintrograph summarizes the two preceding sections. Random allocation of observational units to treatment and random samples from the population lead to ideal studies, but may be impossible due to ethical considerations. 
...
#| fig-cap: Illustration of continuous (left) and discrete variables (right). Artwork
#|   by Allison Horst [shared under the CC BY 4.0 license](https://creativecommons.org/licenses/by/4.0/).
#| echo: false
#| out-width: '80%'
...
The [Parcours  AGIR](https://www.hec.ca/programmes/baccalaureats/parcours-agir/index.html) at HEC Montréal is a pilot project for Bachelor in Administration students that was initiated to study the impact of flipped classroom and active learning on performance.
