...
This course covers experimental designs.  In an experiment, the researcher manipulates one or more features (say the complexity of a text the person must read, or the type of advertisement campaign displayed, etc.) to study their impact. Observational data, such as that collected in survey, are not manipulated: the researcher merely observes differences for an outcome based on other characteristics without interfering. For example, an economist cannot change the interest rates to study their impact on mortage loan default, but can observe the impacts of a steep increase.
...
:::pitfall name="Quasi experiments"
...
<div class="figure" style="text-align: center">
<img src="figures/HFL-A1958.jpg" alt="[1958 plan for the Highfield Ley--Arable Experiment](http://www.era.rothamsted.ac.uk/eradoc/article/PS-Highfield-Ley-Arable-1-1). Source: Rothamsted Research Station,  reproduced under the [CC BY 4.0 license](https://creativecommons.org/licenses/by/4.0/)." width="85%" />
