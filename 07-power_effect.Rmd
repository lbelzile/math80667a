...
region <- data.frame(start = c(0, cut),
                     ...
                     region = factor(c("reject", "fail to reject")))
...
The plot in \@ref(fig:powercurve) shows the null (full line) distribution and the true alternative (dashed line). The noncentral $\mathsf{F}$ is shifted to the right and right skewed. The power is the area in white in the rejection region.
