...
```{example label="Confounding"}
A group of professors are excited about a new pedagogical approach called flipped classroom, in which students learn the material ahead of class asynchronously; the time in class is devoted to active learning activities. To convince the school to change the way first-year courses are taught, they decide to carry a study comparing the results of their section relative to that of the others. At the beginning of the academic year, students can opt in one of those sections.

Do you think the resulting study will be valid? Explain the problems with this approach and list potential confounders that should be controlled for.
```
