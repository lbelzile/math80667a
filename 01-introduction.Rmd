...
```{r sampling, echo = FALSE, eval = TRUE, fig.cap = "Illustration of three sampling schemes from nine stratum: simple random sampling (left), stratified sampling (middle) and cluster sampling (right).", cache = TRUE}
set.seed(1234)
nclass <- 9L
