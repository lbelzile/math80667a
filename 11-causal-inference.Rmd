...
```{r xkcd2652, out.width = '60%', fig.cap = "xkcd comic [2652 (Proxy Variable) by Randall Munroe](https://xkcd.com/2533/). Alt text: Our work has produced great answers. Now someone just needs to figure out which questions they go with. Cartoon reprinted under the [CC BY-NC 2.5 license](https://creativecommons.org/licenses/by-nc/2.5/)."}
...
$$\textsf{NIE}(x, x^*) = \mathsf{E}(Y_{x^*, M_{x}} - Y_{x^*,  M_{x^*}})$$
