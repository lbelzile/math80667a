...
knitr::kable(tab_anova,
  ...
  caption = "Analysis of variance tables for the models without $\\texttt{familiarity}$.") |>
  kableExtra::kable_styling(full_width = TRUE)
knitr::kable(tab_ancova,
  digits = c(0,2,1,2,3,3),
  caption = "Analysis of variance tables for the models with $\\texttt{familiarity}$.") |>
  kableExtra::kable_styling(full_width = TRUE)
```
...
tab_ancova$p.value <- papaja::apa_p(tab_ancova$p.value)
# Output coefficients and t-tests
knitr::kable(list(tab_anova,
                  tab_ancova),
  digits = c(0,2,1,2,3,3),
  caption = "Analysis of variance tables for the model with (left) and without (right) $\\texttt{prior}$ belief score.") |>
  kableExtra::kable_styling(full_width = TRUE)
```
...
knitr::kable(tab_anova,
  digits = c(0,2,1,2,3,3),
  caption = "Pairwise contrasts with $p$-values adjusted using Holm--Bonferroni for the ANOVA model (without $\\texttt{prior}$ belief score).") |>
  kableExtra::kable_styling(full_width = TRUE)

knitr::kable(tab_ancova,
  digits = c(0,2,1,2,3,3),
  caption = "Pairwise contrasts with $p$-values adjusted using Holm--Bonferroni for the ANCOVA model (with $\\texttt{prior}$ belief score).") |>
  kableExtra::kable_styling(full_width = TRUE)
```
...
knitr::kable(SSVB21_S3_summary, 
             caption = "Summary statistics of belief as a function of time of measurement and experimental condition.", digits = 2) |>
  kableExtra::kable_styling(full_width = TRUE)
```
