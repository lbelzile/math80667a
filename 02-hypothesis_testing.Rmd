...
No difference between experimental conditions translates into the null hypothesis as $\mathscr{H}_0: \beta_1=0$ vs $\mathscr{H}_0: \beta_1 \neq 0$.  The likelihood ratio test comparing the regression model with and without $\texttt{video}$ the statistic is $R=`r papaja::printnum(LRT_negbin)`$ ($p$-value based on $\chi^2_1$ of $`r papaja::print_p(pval_negbin)`$). We conclude the average number of ideas is different, with summary statistics suggesting that virtual pairs generate fewer ideas.
